...
# Add CORS middleware - this time I'll be very careful about the origins
...
for origin in allowed_origins_list:
    ...
    if stripped:  # Only add non-empty origins
...
print(f"Setting up CORS with origins: {allowed_origins}")
...
# Include only basic API routers for now to debug
print("About to import auth router...")
from .api.auth import auth_router
print("Auth router imported successfully")
app.include_router(auth_router, prefix="/api")

print("About to import tasks router...")
from .api.tasks import tasks_router
print("Tasks router imported successfully")
app.include_router(tasks_router, prefix="/api")

print("About to import chat router...")
